...
// Using a numeric hash (x * tileCount + y) for better performance than string keys.
...
function collision(head) {
    // Bolt: O(1) lookup instead of O(n) array scan.
...
function resetGame() {
    ...
    // Bolt: Re-initialize the Set for O(1) lookups on game reset.
