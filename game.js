...
// snakeSet stores the coordinates of each snake segment as a unique numeric hash (x * tileCount + y).
// This allows for O(1) collision detection and food placement checks.
...
function collision(head) {
    // Using Set.has() for O(1) complexity instead of Array.some() (O(n)).
